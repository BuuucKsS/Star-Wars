...
$vaisseau5 = [
    ...
    "apparitions" => "Présent dans toutes les trilogies et Rogue One.",
    "capacités" => "Capable de transporter des troupes, véhicules et chasseurs TIE.",
    "point_faible" => "Sa taille le rend vulnérable aux attaques ciblées sur ses systèmes vitaux."
];
...
$vaisseau6 = [
    ...
    "point_faible" => "Peu équipé pour le combat spatial prolongé."
];
...
$vaisseau7 = [
    ...
    "apparitions" => "Un Nouvel Espoir (Destruction 1), Le Retour du Jedi (Destruction 2), Rogue One (Origine).",
    "capacités" => "Destruction planétaire, capacité de transport de troupes et de chasseurs TIE.",
    "point_faible" => "Conduit d'évacuation thermique vulnérable (version 1), générateur de bouclier (version 2)."
];
