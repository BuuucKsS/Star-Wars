...
$planete1 = [
    ...
    "caractéristiques" => [
        ...
        "type" => "Désertique",
        "coordonnees" => "Région des Territoires Extérieurs",
        "gravite" => "Standard (1.0G)",
        "langues" => "Galactique Basique, Jawaese",
    ],
...
$planete2 = [
    ...
    "caractéristiques" => [
        ...
        "type" => "Urbaine",
        "coordonnees" => "Noyau galactique",
        "gravite" => "Standard (1.0G)",
        "langues" => "Galactique Basique",
    ],
...
$planete3 = [
    ...
    "caractéristiques" => [
        ...
        "type" => "Terrestre",
        "coordonnees" => "Région de la Bordure Médiane",
        "gravite" => "Standard (1.0G)",
        "langues" => "Galactique Basique, Gungan",
    ],
...
$planete4 = [
    ...
    "caractéristiques" => [
        ...
        "type" => "Glaciaire",
        "coordonnees" => "Région de la Bordure Extérieure",
        "gravite" => "Légèrement inférieure à la norme",
        "langues" => "Galactique Basique",
    ],
...
$planete5 = [
    ...
    "caractéristiques" => [
        ...
        "type" => "Forestière",
        "coordonnees" => "Bordure Extérieure",
        "gravite" => "Légèrement inférieure à la norme",
        "langues" => "Ewokese, Galactique Basique",
    ],
...
$planete8 = [
    ...
    "caractéristiques" => [
        ...
        "type" => "Jungle",
        "coordonnees" => "Bordure Médiane",
        "gravite" => "Normale",
        "langues" => "Shyriiwook, Galactique Basique",
    ],
...
$planete10 = [
    ...
    "lien" => "https://fr.wikipedia.org/wiki/Alderaan",
];



$planetes = [$planete1, $planete2, $planete3, $planete4, $planete5, $planete6, $planete7, $planete8, $planete9, $planete10];
?>
